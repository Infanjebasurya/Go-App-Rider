...
class DocumentUploadCubit extends Cubit<DocumentUploadState> {
  ...
  DocumentUploadCubit({
    ...
    required DrivingLicenseUploadRemoteDataSource drivingLicenseUploadRemoteDataSource,
    required ProfileImageUploadRemoteDataSource profileImageUploadRemoteDataSource,
  ...
  final DrivingLicenseUploadRemoteDataSource _drivingLicenseUploadRemoteDataSource;
  ...
  Future<void> _uploadVehicleRcAndContinue() async {
    ...
    _emitState(
      state.copyWith(
        statusMessage:
            (response.message ?? 'Vehicle RC uploaded successfully.').trim(),
        statusIsError: false,
      ),
    );
