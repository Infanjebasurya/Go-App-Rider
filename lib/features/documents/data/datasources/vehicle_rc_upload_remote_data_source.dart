...
class VehicleRcUploadRemoteDataSourceImpl implements VehicleRcUploadRemoteDataSource {
  ...
  Future<UploadVehicleRcResponseModel> upload({
    ...
    try {
      ...
      final UploadVehicleRcResponseModel parsed = UploadVehicleRcResponseModel.fromJson(
