...
class VerificationCubit extends Cubit<VerificationState> {
  VerificationCubit({required SubmitAllDocumentsRemoteDataSource submitAllDataSource})
  ...
  Future<void> submitForReview() async {
    ...
    final docsComplete = profileImageUploaded && syncedDocs.every((doc) => doc.isCompleted);
